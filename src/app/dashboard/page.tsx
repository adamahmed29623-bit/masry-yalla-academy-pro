          ...
          <div className="bg-white/5 border border-white/10 rounded-[3rem] p-10 backdrop-blur-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-6">
              <div className="bg-white/5 p-6 rounded-[2rem] border-r-4 border-amber-500">
                ...
                <button className="text-xs bg-amber-500 text-black px-6 py-2 rounded-full font-black hover:scale-105 transition-all">
                  مواصلة
                </button>
              </div>
              <div className="bg-white/5 p-6 rounded-[2rem] opacity-50">
                ...
                <button className="text-xs border border-white/20 px-6 py-2 rounded-full font-black text-white">
                  مراجعة
                </button>
              </div>
            </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-[3rem] p-8 backdrop-blur-xl">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-white/5 rounded-2xl border border-white/5 flex justify-between items-center">
                ...
                <button className="bg-white/10 px-4 py-2 rounded-xl text-[10px] font-black hover:bg-amber-500 transition-all text-white hover:text-black">
                  استبدال
                </button>
              </div>
            </div>
